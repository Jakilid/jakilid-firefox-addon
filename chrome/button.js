...
var jakilidAddonUi = function(){
	...
	function onButtonClick(e)
	{
		...
		switch (state)
		{
			case LOCKED_STATE:
				//open login panel
				document.getElementById('login').openPopup(document.getElementById('jakilid-button'), "after_start", 0, 0, false, false);
				break;
			case UNLOCKED_STATE:
				//open ui
				openJakilid();
	...
	function askSavingLogin(acc)
	{
		...
		document.getElementById('askSave').openPopup(document.getElementById('jakilid-button'), "after_start", 0, 0, false, false);
	}
